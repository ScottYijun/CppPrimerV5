...
#ifndef Sales_data_14_22_h
#define Sales_data_14_22_h
...
public:
    ...
    Sales_item& operator=(const std::string &isbn);
...
Sales_item& Sales_item::operator =(const std::string &isbn)
{
    bookNo = isbn;
    return *this;
}
